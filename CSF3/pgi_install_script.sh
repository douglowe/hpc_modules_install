...
INROOT=/mnt/iusers01/support/mbessdl2/privatemodules_packages/csf3/compilers
APPROOT=$INROOT/pgi
...
# this might not work - may have to go through the website instead? 
wget https://download.pgroup.com/secure/pgilinux-2019-194-x86-64.tar.gz

cd ../build
mkdir $APPROOT
cd $APPROOT
tar xzf ../../archive/pgilinux-2019-194-x86-64.tar.gz



## PGI's installation guide is here: 
# https://www.pgroup.com/resources/docs/19.4/x86/pgi-install-guide/index.htm#install-linux-pgi
