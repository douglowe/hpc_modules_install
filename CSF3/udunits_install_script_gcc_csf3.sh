...
APPROOT=/mnt/iusers01/support/mbessdl2/privatemodules_packages/csf3/libs/gcc/udunits
...
wget ftp://ftp.unidata.ucar.edu/pub/udunits/udunits-${APPVER}.tar.gz

cd ../build
tar xzf ../archive/udunits-${APPVER}.tar.gz
...
MDIR=/mnt/iusers01/support/mbessdl2/privatemodules/priv_libs/gcc/udunits
...
MPATH=priv_libs/gcc/udunits/${APPVER}
...
set    APPVER         ${APPVER}
set    APPNAME        udunits
set    APPNAMECAPS    UDUNITS
set    APPURL        https://www.unidata.ucar.edu/software/udunits/
