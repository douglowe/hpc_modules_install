...
APPROOT=/mnt/iusers01/support/mbessdl2/privatemodules_packages/csf3/libs/gcc/expat
...
wget https://github.com/libexpat/libexpat/releases/download/R_${APPSTR}/expat-${APPVER}.tar.bz2

cd ../build
tar xf ../archive/expat-${APPVER}.tar.bz2
