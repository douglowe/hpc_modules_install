...
cd $APPROOT
mkdir -p $APPVER/lib archive build
cd archive

git clone https://github.com/cjcoats/ioapi-3.2

cd ../build
cp -a ../archive/ioapi-3.2 .
...
module load libs/gcc/netcdf/4.9.2_nodap


cd ioapi

cp Makefile.nocpl Makefile
sed -e 's/-fopenmp/# -fopenmp/g' Makeinclude.Linux2_x86_64gfort > Makeinclude.Linux2_x86_64gfort_gcc_8.2.0

export BIN=Linux2_x86_64gfort_gcc_8.2.0

make 'INSTALL=$APPDIR/bin' 2>&1 | tee make.log
