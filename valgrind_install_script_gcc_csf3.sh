...
APPROOT=/mnt/iusers01/support/mbessdl2/privatemodules_packages/csf3/apps/valgrind
...
wget http://www.valgrind.org/downloads/valgrind-${APPVER}.tar.bz2


cd ../build
tar xf ../archive/valgrind-${APPVER}.tar.bz2
...
MDIR=/mnt/iusers01/support/mbessdl2/privatemodules/priv_apps/valgrind
...
MPATH=priv_apps/valgrind/${APPVER}
...
# If using MPI and or CUDA, add MPIVER and CUVER with suitable text
proc ModulesHelp { } {
    global APPVER APPNAME APPCSFURL APPURL COMPVER COMPNAME

    puts stderr \"
    Adds \$APPNAME \$APPVER to your PATH environment variable and any necessary
    dependent modulefiles.
    
    It has been compiled with the \$COMPNAME \$COMPVER compiler.
...
# You MIGHT HAVE TO REMOVE THE prereq MODULEFILES FROM ABOVE
#
# module load mpi/$COMPDIR/openmpi/$MPIVER
# module load libs/cuda/$CUVER
#
# module load libs/otherlib/7.8.9
# module load ......

set     APPDIR           /mnt/iusers01/support/mbessdl2/privatemodules_packages/csf3/apps/\$APPNAME/\$APPVER
